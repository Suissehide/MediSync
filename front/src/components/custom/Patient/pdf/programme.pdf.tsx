...
const TIPS = [
  ...
  },
  {
    ...
    text: "Un bon repos est indispensable pour votre récupération et pour profiter pleinement de chaque activité. Essayez de venir reposé·e, en forme, et à l'écoute de votre corps.",
  },
]
      ...
      <View style={styles.tipsInfoBanner}>
        <Text style={styles.tipsInfoText}>
          <Text style={styles.tipsInfoBold}>
            Souvenez-vous que ce programme est fait pour vous, et que chaque effort vous fait vous rapprocher d'un meilleur équilibre de vie.{' '}
          </Text>
